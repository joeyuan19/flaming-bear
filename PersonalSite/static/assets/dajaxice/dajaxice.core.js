...
var Dajaxice = {
    ...
    get_section: function(callback_function, argv, custom_settings){
        return Dajaxice.call('get_section', 'GET', callback_function, argv, custom_settings);
    },
...
,
    ...
    bye: function(callback_function, argv, custom_settings){
        return Dajaxice.call('simple.bye', 'GET', callback_function, argv, custom_settings);
    },

    hello: function(callback_function, argv, custom_settings){
        return Dajaxice.call('simple.hello', 'GET', callback_function, argv, custom_settings);
    },

    lol: function(callback_function, argv, custom_settings){
        return Dajaxice.call('simple.lol', 'POST', callback_function, argv, custom_settings);
    }
