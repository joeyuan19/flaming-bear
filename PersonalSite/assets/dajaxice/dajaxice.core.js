...
var Dajaxice = {
    ...
    load: function(callback_function, argv, custom_settings){
        return Dajaxice.call('content.load', 'POST', callback_function, argv, custom_settings);
    },

    thisFunctionWillCallMe: function(callback_function, argv, custom_settings){
        return Dajaxice.call('content.thisFunctionWillCallMe', 'POST', callback_function, argv, custom_settings);
    },

    thisFunctionWillEmailMe: function(callback_function, argv, custom_settings){
        return Dajaxice.call('content.thisFunctionWillEmailMe', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    solve: function(callback_function, argv, custom_settings){
        return Dajaxice.call('sudoku.solve', 'POST', callback_function, argv, custom_settings);
    }
