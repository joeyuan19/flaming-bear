...
var Dajaxice = {
    ...
    get_result_page: function(callback_function, argv, custom_settings){
        return Dajaxice.call('search.get_result_page', 'POST', callback_function, argv, custom_settings);
    }
