...
function resize_all() {
	...
	$('#debug').html(width + '<br>' + height);
	$('#bg-img').css('width',width > 500 ? width : 500);
	$('#bg-img').css('height',min_height);
	$('#content').css('width', min_side);
	$('#content').css('height',min_side);
	$('#content').css('top',(height > width ? (height - min_side)/2.0 : 0));
	$('#content').css('left',(height > width ? 0 : (width - min_side)/2.0));
	$('#menu').css('top',0);
	$('#menu').css('left',0);
	$('#menu').css('width','100%');
	$('#menu').css('height','100%');
